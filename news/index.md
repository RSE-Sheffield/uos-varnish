...
- Add support for dark mode image adjustment
  ([@astroDimitrios](https://github.com/astroDimitrios),
  [\#153](https://github.com/RSE-Sheffield/uos-varnish/issues/153))

### MISC

- Update links to new Carpentries handbook
  ([@robadob](https://github.com/robadob)
  [\#164](https://github.com/RSE-Sheffield/uos-varnish/issues/164))
- Improve h3 and h4 font sizes on large resolutions
  ([@Sheargrub](https://github.com/Sheargrub)
  [\#165](https://github.com/RSE-Sheffield/uos-varnish/issues/165))
...
- Two new Sass variables (`default_font` and `mono_font`) have been
  ...
  [\#151](https://github.com/RSE-Sheffield/uos-varnish/issues/151))
- Carpentry-specific favicons are now used automatically based on the
  ...
  [\#152](https://github.com/RSE-Sheffield/uos-varnish/issues/152),
  based on a report from [@zkamvar](https://github.com/zkamvar) in
  [\#33](https://github.com/RSE-Sheffield/uos-varnish/issues/33)).
- Addition of the `caution` callout
  ([@MttArmstrong](https://github.com/MttArmstrong)
  [\#149](https://github.com/RSE-Sheffield/uos-varnish/issues/149))
- Improve CSS rendering of checklists by removing the bullet point and
  ...
  [\#156](https://github.com/RSE-Sheffield/uos-varnish/issues/156),
  fixed [@froggleston](https://github.com/froggleston))
- Improve support for Ukrainian alphabet by moving from specific Mulish
  ...
  [\#120](https://github.com/RSE-Sheffield/uos-varnish/issues/120),
  implemented
  [@olexandr-konovalov](https://github.com/olexandr-konovalov),
  [@froggleston](https://github.com/froggleston)
  [\#133](https://github.com/RSE-Sheffield/uos-varnish/issues/133))
...
- The lesson page footer now supports either a CITATION or CITATION.cff
  ...
  [\#122](https://github.com/RSE-Sheffield/uos-varnish/issues/122);
  [@froggleston](https://github.com/froggleston),
...
- Replace the problematic search box with a much simpler and functional
  ...
  [\#131](https://github.com/RSE-Sheffield/uos-varnish/issues/131) ).
...
- Translation of lesson elements is now incorporated. Translation
  ...
  [\#104](https://github.com/RSE-Sheffield/uos-varnish/issues/104);
  implemented: [@zkamvar](https://github.com/zkamvar) and
  [@joelnitta](https://github.com/joelnitta),
  [\#105](https://github.com/RSE-Sheffield/uos-varnish/issues/105))
...
- Overview box heading font sizes now scaled based on viewport size.
  ...
  [\#83](https://github.com/RSE-Sheffield/uos-varnish/issues/83),
  ...
  [@robadob](https://github.com/robadob),
  [\#111](https://github.com/RSE-Sheffield/uos-varnish/issues/111);
  fixed: [@froggleston](https://github.com/froggleston),
  [\#109](https://github.com/RSE-Sheffield/uos-varnish/issues/109),
  [@robadob](https://github.com/robadob),
  [\#112](https://github.com/RSE-Sheffield/uos-varnish/issues/112)).
- Spacing and alignment of text improved in Software Carpentry logo.
  (reported: [@tobyhodges](https://github.com/tobyhodges),
  [\#107](https://github.com/RSE-Sheffield/uos-varnish/issues/107);
  fixed [@tobyhodges](https://github.com/tobyhodges),
  [\#110](https://github.com/RSE-Sheffield/uos-varnish/issues/110)).
- Lesson title collision with search box resolved. (reported:
  [@ocasia](https://github.com/ocasia),
  [\#84](https://github.com/RSE-Sheffield/uos-varnish/issues/84); fixed
  [@robadob](https://github.com/robadob),
  [\#113](https://github.com/RSE-Sheffield/uos-varnish/issues/113)).
...
- Code blocks in narrative no longer have a white background on top of
  ...
  [@zkamvar](https://github.com/zkamvar),
  [\#103](https://github.com/RSE-Sheffield/uos-varnish/issues/103)).
...
- Provide an improved contrast to inline code within callout blocks by
  ...
  ([\#99](https://github.com/RSE-Sheffield/uos-varnish/issues/99));
  fixed [@froggleston](https://github.com/froggleston),
  [\#100](https://github.com/RSE-Sheffield/uos-varnish/issues/100))
- Back and forward navigation titles have been fixed to keep raw content
  ...
  ([\#98](https://github.com/RSE-Sheffield/uos-varnish/issues/98));
  fixed [@froggleston](https://github.com/froggleston),
  [\#101](https://github.com/RSE-Sheffield/uos-varnish/issues/101))

## varnish 0.3.1

- Lesson titles no longer escape ampersands (reported and fixed:
  [@Robadob](https://github.com/Robadob),
  [\#95](https://github.com/RSE-Sheffield/uos-varnish/issues/95))
...
- Lesson overview pages are now supported (reported:
  ...
  [@zkamvar](https://github.com/zkamvar),
  [\#87](https://github.com/RSE-Sheffield/uos-varnish/issues/87)). These
...
- The `spoiler` dropdown item has been implemented to allow authors to
  ...
  [@tobyhodges](https://github.com/tobyhodges),
  [\#92](https://github.com/RSE-Sheffield/uos-varnish/issues/92))
...
- Non-math elements on the same line will no longer be treated as math
  ...
  [\#88](https://github.com/RSE-Sheffield/uos-varnish/issues/88); fixed:
  [@zkamvar](https://github.com/zkamvar),
  [\#90](https://github.com/RSE-Sheffield/uos-varnish/issues/90))
- Bold italic text will now render correctly (reported:
  [@marklcrowe](https://github.com/marklcrowe),
  [\#89](https://github.com/RSE-Sheffield/uos-varnish/issues/89); fixed:
  [@zkamvar](https://github.com/zkamvar),
  [\#91](https://github.com/RSE-Sheffield/uos-varnish/issues/91))
...
- The margin below the schedule table in instructor view is now 25px
  ...
  [\#81](https://github.com/RSE-Sheffield/uos-varnish/issues/81); fixed:
  [@bencomp](https://github.com/bencomp),
  [\#82](https://github.com/RSE-Sheffield/uos-varnish/issues/82)).
...
- The Carpentries Lab logo has been updated (reported:
  [@tobyhodges](https://github.com/tobyhodges),
  [\#59](https://github.com/RSE-Sheffield/uos-varnish/issues/59); fixed:
  [@tobyhodges](https://github.com/tobyhodges),
  [\#76](https://github.com/RSE-Sheffield/uos-varnish/issues/76))
...
- Table display CSS is set to `table` as opposed to `block`, thus
  ...
  (fixed: [@zkamvar](https://github.com/zkamvar),
  [\#74](https://github.com/RSE-Sheffield/uos-varnish/issues/74))
...
- Table formatting has been fixed to no longer include 100px padding in
  ...
  [\#72](https://github.com/RSE-Sheffield/uos-varnish/issues/72); fixed:
...
- Formatted print media to avoid breaking in important contexts (code
  ...
  [\#70](https://github.com/RSE-Sheffield/uos-varnish/issues/70); fixed:
  [@zkamvar](https://github.com/zkamvar),
  [\#71](https://github.com/RSE-Sheffield/uos-varnish/issues/71))

## varnish 0.2.10

- Fix issue with bullet points in callouts being mis-aligned (reported:
  [@sstevens2](https://github.com/sstevens2),
  [\#68](https://github.com/RSE-Sheffield/uos-varnish/issues/68); fixed:
  [@zkamvar](https://github.com/zkamvar),
  [\#69](https://github.com/RSE-Sheffield/uos-varnish/issues/69))
...
- Workbench Beta phase “Edit on GitHub” links are now formatted
  ...
  [\#65](https://github.com/RSE-Sheffield/uos-varnish/issues/65); fixed
  [@zkamvar](https://github.com/zkamvar),
  [\#66](https://github.com/RSE-Sheffield/uos-varnish/issues/66))
...
- Callout block titles have been improved: The underline height for
  ...
  [\#53](https://github.com/RSE-Sheffield/uos-varnish/issues/53); fixed
  [@zkamvar](https://github.com/zkamvar),
  [\#55](https://github.com/RSE-Sheffield/uos-varnish/issues/55)).
  Moreover, the text transformation will no longer affect `code` and
  `kbd` elements.
...
- Sidebar navigation now says “Episodes” instead of “Expand” when
  ...
  ([\#47](https://github.com/RSE-Sheffield/uos-varnish/issues/47));
  fixed by [@zkamvar](https://github.com/zkamvar),
  [\#56](https://github.com/RSE-Sheffield/uos-varnish/issues/56))
...
- The hamburger menu for mobile devices now has a border so it’s more
  ...
  ([\#47](https://github.com/RSE-Sheffield/uos-varnish/issues/47));
  fixed by [@zkamvar](https://github.com/zkamvar),
  [\#57](https://github.com/RSE-Sheffield/uos-varnish/issues/57))
...
- Add support for displaying anchor links (requested
  ...
  [\#54](https://github.com/RSE-Sheffield/uos-varnish/issues/54) by
  [@zkamvar](https://github.com/zkamvar))
...
- Formatting of list elements in the solutions and instructor notes now
  ...
  [\#51](https://github.com/RSE-Sheffield/uos-varnish/issues/51) by
  [@tobyhodges](https://github.com/tobyhodges), fixed:
  [\#52](https://github.com/RSE-Sheffield/uos-varnish/issues/52) by
  [@zkamvar](https://github.com/zkamvar))
...
- The sidebar navigation in mobile and tablet views now includes all the
  ...
  [\#49](https://github.com/RSE-Sheffield/uos-varnish/issues/49), fixed:
  [\#50](https://github.com/RSE-Sheffield/uos-varnish/issues/50) by
  [@zkamvar](https://github.com/zkamvar))
...
- The sidebar state (expanded or collapsed) will now persist during
  ...
  [\#43](https://github.com/RSE-Sheffield/uos-varnish/issues/43) by
  [@anenadic](https://github.com/anenadic), fixed
  [\#46](https://github.com/RSE-Sheffield/uos-varnish/issues/46),
...
- The search field has been disabled to avoid confusion. We have not yet
  ...
  available.
  ([\#44](https://github.com/RSE-Sheffield/uos-varnish/issues/44) by
  [@zkamvar](https://github.com/zkamvar))
...
- indicators for lesson development stage (pre-alpha, alpha, beta) have
  ...
  ([\#39](https://github.com/RSE-Sheffield/uos-varnish/issues/39) by
...
- dropdown navigation no longer is hidden by the sidebar on XXL screens;
  ...
  [\#35](https://github.com/RSE-Sheffield/uos-varnish/issues/35) by
  [@brownsarahm](https://github.com/brownsarahm), fixed:
  [\#36](https://github.com/RSE-Sheffield/uos-varnish/issues/36) by
  [@zkamvar](https://github.com/zkamvar))
...
- blockquotes are now more clearly delineated from the rest of the
  content (reported:
  [\#27](https://github.com/RSE-Sheffield/uos-varnish/issues/27) by
  [@fiveop](https://github.com/fiveop), fixed:
  [\#31](https://github.com/RSE-Sheffield/uos-varnish/issues/31) by
  [@zkamvar](https://github.com/zkamvar))
...
- Add matmo analytics in the footer
  ...
  [\#17](https://github.com/RSE-Sheffield/uos-varnish/issues/17))
